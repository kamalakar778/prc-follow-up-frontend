...
const styles = {
  section: {    marginBottom: "12px",    padding: "8px",    border: "1px solid #ccc",    borderRadius: "6px",    backgroundColor: "#f9f9f9",  },
  horizontalLayout: {    display: "flex",    gap: "16px",    alignItems: "flex-start",    flexWrap: "nowrap",  },
  leftPanel: {    display: "flex",flexDirection: "row",    gap: "12px",    maxHeight: "400px",    overflowY: "auto",    overflowX: "hidden",    flexShrink: 0,    maxWidth: "70%",    alignItems: "flex-start",  },
  column: {    display: "flex",    flexDirection: "column",  },
  groupLabel: {    fontWeight: "500",    fontSize: "14px",    marginBottom: "4px",    color: "#333",    textTransform: "capitalize",  },
  button: {    padding: "5px 8px",    fontSize: "14px",    border: "1px solid #888",    borderRadius: "4px",    backgroundColor: "#F5F5F5",    color: "#333",    cursor: "pointer",    margin: "1px",  },
  selectedButton: {    backgroundColor: "#E0F0FF",    fontSize: "14px",    color: "#0066cc",    borderColor: "#0066cc",  },
  copyButton: {    backgroundColor: "#d4edda",    borderColor: "#c3e6cb",    color: "#155724",    marginTop: "22px",    minWidth: "70px",  },
  addButton: {    backgroundColor: "#ffeeba",    borderColor: "#ffeeba",    color: "#856404",    marginTop: "6px",    minWidth: "70px",  },
  resetButton: {    backgroundColor: "#f8d7da",    borderColor: "#f5c6cb",    color: "#721c24",    marginTop: "6px",    minWidth: "70px",  },
  copyAllButton: {    backgroundColor: "#cce5ff",    borderColor: "#b8daff",    color: "#004085",    marginTop: "8px",    minWidth: "160px",    alignSelf: "flex-start",  },
  previewBox: {    padding: "8px",    border: "1px dashed #aaa",    borderRadius: "6px",    backgroundColor: "#fcfcfc",    color: "#333",    fontSize: "13px",    minWidth: "250px",    maxWidth: "300px",    flexShrink: 0,    height: "fit-content",  },
  previewLabel: {    fontWeight: "bold",    marginBottom: "6px",  },
  previewItem: {display: "inline-block",    padding: "4px 8px",    margin: "4px",    border: "1px solid #aaa",    borderRadius: "4px",    cursor: "pointer",    backgroundColor: "#f0f0f0",    color: "#333",  },
  previewDisabled: {    textDecoration: "line-through",    opacity: 0.6,    backgroundColor: "#e2e2e2",    color: "#999",    borderColor: "#ccc",    cursor: "pointer",  },
};
