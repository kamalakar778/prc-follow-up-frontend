...
export const MedicationProvider = ({ children }) => {
  ...
  const predefinedDosages = {
    Eliquis:["2.5 mg", "5 mg", "7.5 mg", "10 mg"],
    gabapentin: ["100 mg", "200 mg", "300 mg", "400 mg", "500 mg","600 mg", "800 mg"],
    mobic: ["7.5 mg", "15 mg",],
