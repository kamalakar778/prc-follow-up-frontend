...
const SignatureLine = ({ onChange, dateOfEvaluation, followUpValue, setFollowUpValue  }) => {

    useEffect(() => {
    if (followUpValue === "Several weeks after procedure") {
      setFollowUpValue("Several weeks after procedure");
    }
  }, [followUpValue, setFollowUpValue]);
