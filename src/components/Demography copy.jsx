...
@media (max-width: 768px) {
  ...
  .responsive-wrap {     flex-direction: row !important;     flex-wrap: wrap !important;     gap: 0.3rem !important;     max-width: 100%;   } } `;

const styles = {
  container: {    fontFamily: "Arial, sans-serif",     maxWidth: 1200,     margin: "10px auto",     padding: "0.5rem",     backgroundColor: "#fff",     borderRadius: "4px",     boxShadow: "0 2px 6px rgba(0,0,0,0.1)",   },
  section: {     padding: "0.75rem",     border: "1px solid #000",     borderRadius: "4px",     backgroundColor: "#f9f9f9",     marginTop: "1rem",  },
  grid: {     width: "100%",     display: "grid",     gridTemplateColumns: "1fr 1fr",     gap: "0.5rem",   },
  label: {     display: "flex",     flexDirection: "row",     alignItems: "center",     fontSize: "16px",     color: "#333",     gap: "0.3rem",     marginBottom: "-0.2rem",   },
  fileNameinput: {
    margin: "auto",      flex: 1,    padding: "8px",    borderRadius: "4px",    border: "1px solid #ccc",     fontSize: "15px",  },
  input: {
    display: "flex",    maxWidth: "40%",    flexDirection: "row",    minWidth: "180px",    flex: 1,         padding: "6px",    borderRadius: "4px",    border: "1px solid #ccc",    fontSize: "15px",    margin: "6px",  },
  dateInputContainer: {
    display: "flex",    maxWidth: "10%",    alignItems: "center",    gap: "0.25rem",  },
  dateInput: {
    padding: "6px",    margin: "0px 0px",    borderRadius: "4px",    border: "1px solid #ccc",     fontSize: "16px",    width: "160px",  },
  buttonSmall: {
    padding: "4px 8px",    margin: "0px 0px",    borderRadius: "4px",    border: "none",    backgroundColor: "#3498db",    color: "#fff",    cursor: "pointer",    fontSize: "16px",  },
  select: {
    width: "150px",    flex: 1,    margin: "5px",    padding: "0.4rem",    borderRadius: "4px",    border: "1px solid #ccc",     fontSize: "14px",    backgroundColor: "#fff",   },
  button: {    padding: "0.6rem 0.8rem",    margin: "0.5rem",    borderRadius: "4px",    border: "none",    fontWeight: "bold",    fontSize: "16px",    cursor: "pointer",    backgroundColor: "#3498db",    color: "#fff",   },
  optionButton: (isSelected) => ({    margin: 1,    padding: "6px 6px",    borderRadius: "8px",    border: "1px solid",    borderColor: isSelected ? "green" : "#999",    backgroundColor: isSelected ? "#e0f7e9" : "#f0f0f0",     color: isSelected ? "green" : "#333",    fontWeight: isSelected ? "bold" : "normal",     cursor: "pointer",    fontSize: "15px",    lineHeight: "1.4",    whiteSpace: "nowrap",    display: "inline-block"  }),
  optionButton2: (isSelected) => ({
    margin: 0,    marginTop: "4px",    padding: "4px 4px",    borderRadius: "8px",    border: "1px solid",    borderColor: isSelected ? "green" : "#999",    backgroundColor: isSelected ? "#e0f7e9" : "#f0f0f0",    color: isSelected ? "green" : "#333",    fontWeight: isSelected ? "bold" : "normal",    cursor: "pointer",    fontSize: "15px",    lineHeight: "1.4",   whiteSpace: "nowrap",    display: "inline-block"  }),
  selectedTag: {    backgroundColor: "#e0f7fa",    border: "1px solid #00acc1",    borderRadius: "20px",    padding: "0.25rem 0.75rem",    display: "flex",    alignItems: "center",    gap: "0.5rem",  },
  removeTagButton: {    background: "transparent",     border: "none",     cursor: "pointer",     color: "#007c91",     fontSize: "1rem",     lineHeight: "1",
  }
};
...
const insuranceOptions = [  "Aetna", "BCBS", "Ambetter", "Cigna", "Commercial", "Humana",  "Medicare", "Medicare B", "MCR", "TriCare", "Trieast",  "WellCare", "PP", "UHC", "Work. Comp", "Self pay", "Medicaid",];
...
const getValidationSchema = (providerOptions = [], fileName = "") => {
  const providerValues = providerOptions.map((opt) => opt.value || Object.values(opt)[0]);
  ...
  return Yup.object({
    ...
    location: Yup.string().test(
      ...
      function (v) {
        return /\(ET\)/i.test(fileName) ? v === "E-town" : true;
      }
    ),

    insuranceList: Yup.array().of(Yup.string()).notRequired(),
    CMA: Yup.array().of(Yup.string()).notRequired(),
    roomNumber: Yup.string().notRequired(),
  });
};
